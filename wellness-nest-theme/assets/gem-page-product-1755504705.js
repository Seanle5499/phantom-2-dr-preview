  ...
  $(document).ready(function(){
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1755514754387').children('.module');
  $module.gfV3Product();
})( window.GemQuery || jQuery );
    ...
    (function(jQuery) {
  var $module = jQuery('#m-1755514754368').children('.module');
  ...
  $module.gfV3ProductImage({
    ...
    (function(jQuery) {
  var $module = jQuery('#m-1755514754361').children('.module');
  ...
  switch(style) {
    ...
    (function(jQuery) {
  var $module = jQuery('#m-1755514754383').children('.module');
  ...
  (function (jQuery) {
  var $module = jQuery("#m-1755514754399").children(".module");
  // You can add custom Javascript code right here.
  ...
  // var $module = jQuery('#m-1755514754324').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
    (function( jQuery ){
  var $module = jQuery('#m-1755514754343').children('.module');
  $module.gfV3ProductCartButton({ onItemAdded: function(data) {}});
})( window.GemQuery || jQuery );
  (function (jQuery) {
    var $module = jQuery("#m-1755514754333").children(".module");
    // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1755514754410').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  
    (function( jQuery ){
  try {
    var $module = jQuery('#m-1755514754356').children('.module');
    var single = $module.attr('data-single');
    var openDefault = $module.attr('data-openDefault');
    var openTab = $module.attr('data-openTab');
    var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1755514892255').children('.module');
  $module.gfV3Product();
})( window.GemQuery || jQuery );
    ...
    (function(jQuery) {
  var $module = jQuery('#m-1755514892362').children('.module');
  var effect = $module.attr('data-effect');
  var magnify = $module.attr('data-zoom-level');
  var displayType = $module.attr('data-displaytype');
  $module.gfV3ProductImage({
    ...
    (function(jQuery) {
  var $module = jQuery('#m-1755514892327').children('.module');
  if($('body').find('.dbtfy')?.length) {
    $module.find("a[href='javascript:void(0)']").off("click").on("click", (event) => {
      event.preventDefault();
    });
  ...
  switch(style) {
    ...
    (function(jQuery) {
  var $module = jQuery('#m-1755514892322').children('.module');
  var swatchText = $module.attr('data-swatch-text') != undefined ? $module.attr('data-swatch-text') : '1';
  $module.gfV3ProductSwatches({
    swatchText: swatchText,
    onSwatchSelected: function(variant, $swatch) {}
  ...
  (function (jQuery) {
  var $module = jQuery("#m-1755514892303").children(".module");
  // You can add custom Javascript code right here.
  ...
  // var $module = jQuery('#m-1755514892386').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
    (function( jQuery ){
  var $module = jQuery('#m-1755514892279').children('.module');
  $module.gfV3ProductCartButton({ onItemAdded: function(data) {}});
})( window.GemQuery || jQuery );
  (function (jQuery) {
    var $module = jQuery("#m-1755514892358").children(".module");
    // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1755514892268').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  
    (function( jQuery ){
  try {
    var $module = jQuery('#m-1755514892285').children('.module');
    var single = $module.attr('data-single');
    var openDefault = $module.attr('data-openDefault');
    var openTab = $module.attr('data-openTab');
    var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
